...
func buildCatalog() *catalog.Catalog {
	return catalog.MustNew(
		...
		containerschecks.Check0003,
		containerschecks.Check0004,
		...
		kernelchecks.Check0018,
		kernelchecks.Check0019,
		kernelchecks.Check0020,
		kernelchecks.Check0021,
		kernelchecks.Check0022,
		kernelchecks.Check0023,
		kernelchecks.Check0024,
		kernelchecks.Check0025,
		kernelchecks.Check0026,
		kernelchecks.Check0027,
		kernelchecks.Check0028,
		kernelchecks.Check0029,
		kernelchecks.Check0030,
		kernelchecks.Check0031,
